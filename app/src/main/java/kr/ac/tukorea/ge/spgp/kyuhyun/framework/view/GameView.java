package kr.ac.tukorea.ge.spgp.kyuhyun.framework.view;
...
public class GameView extends View implements Choreographer.FrameCallback {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        kr.ac.tukorea.ge.spgp.kyuhyun.framework.view.Metrics.concat(canvas);
        if (BuildConfig.DEBUG) {
            canvas.drawRect(kr.ac.tukorea.ge.spgp.kyuhyun.framework.view.Metrics.borderRect, borderPaint);
        }
        scene.draw(canvas);
        canvas.restore();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        kr.ac.tukorea.ge.spgp.kyuhyun.framework.view.Metrics.onSize(w, h);
    }
